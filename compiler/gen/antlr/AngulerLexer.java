...
public class AngulerLexer extends Lexer {
	...
	public static final int
		...
		A_TAG=79, SPAN_TAG=80, BUTTON_TAG=81, BINDING=82, EVENT_BINDING=83, INTERPOLATION=84, 
		FUNCTION=85, INTERFACE=86, CLASS=87, IMPORT=88, FROM=89, EXPORT=90, IF=91, 
		ELSE=92, FOR=93, WHILE=94, DO=95, SWITCH=96, CASE=97, DEFAULT=98, RETURN=99, 
		BREAK=100, CONTINUE=101, BOOLEAN=102, NULL=103, UNDEFINED=104, STRING=105, 
		NUMBER=106, BOOL=107, ANY=108, CONST=109, LET=110, VAR=111, INT=112, IDENTIFIER=113, 
		...
		FLOAT_LITERAL=120, LINE_COMMENT=121, BLOCK_COMMENT=122, WS=123, HTML_WS=124, 
		HTML_OPEN_BRACE=125, HTML_CLOSE_BRACE=126, HTML_CLOSE_PAREN=127, HTML_OPENTAG=128, 
		HTML_TEXT=129;
	public static final int
		HTML_TEXT_MODE=1;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"P_TAG", "IMG_TAG", "A_TAG", "SPAN_TAG", "BUTTON_TAG", "BINDING", "EVENT_BINDING", 
			"INTERPOLATION", "FUNCTION", "INTERFACE", "CLASS", "IMPORT", "FROM", 
			"EXPORT", "IF", "ELSE", "FOR", "WHILE", "DO", "SWITCH", "CASE", "DEFAULT", 
			"RETURN", "BREAK", "CONTINUE", "BOOLEAN", "NULL", "UNDEFINED", "STRING", 
			"NUMBER", "BOOL", "ANY", "CONST", "LET", "VAR", "INT", "IDENTIFIER", 
			"STRING_LITERAL", "TEMPLATE_LITERAL", "DECIMAL_INTEGER_LITERAL", "HEX_INTEGER_LITERAL", 
			"OCTAL_INTEGER_LITERAL", "BINARY_INTEGER_LITERAL", "FLOAT_LITERAL", "LINE_COMMENT", 
			"BLOCK_COMMENT", "WS", "ESC", "HTML_WS", "HTML_OPEN_BRACE", "HTML_CLOSE_BRACE", 
			"HTML_CLOSE_PAREN", "HTML_OPENTAG", "HTML_TEXT"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'@angular'", "'++'", "'--'", "'void'", "'!'", "'?'", null, "'>'", "'<='", 
			"'>='", null, "'/'", "'+'", "'_'", "'*'", "'%'", "'$'", "'&&'", "'||'", 
			"'|'", "'selector'", "'standalone'", "'imports'", "'template'", "'templateUrl'", 
			"'styles'", "'styleUrls'", "'styleUrl'", "'*ngIf'", "'*ngFor'", "'[ngClass]'", 
			"'[ngStyle]'", "'[(ngModel)]'", null, "'#'", "'ng-content'", "'ng-template'", 
			"'@Input'", "'@Output'", "'@ViewChild'", "'@ContentChild'", "'ngOnInit'", 
			"'ngOnChanges'", "'ngOnDestroy'", "'routerLink'", "'router-outlet'", 
			"'formControlName'", "'formGroup'", "'formArray'", "'style'", "'alt'", 
			"'src'", "'href'", "'div'", "'h1'", "'h2'", "'h3'", "'p'", "'img'", "'a'", 
			"'span'", "'button'", null, null, null, "'function'", "'interface'", 
			"'class'", "'import'", "'from'", "'export'", "'if'", "'else'", "'for'", 
			"'while'", "'do'", "'switch'", "'case'", "'default'", "'return'", "'break'", 
			"'continue'", null, "'null'", "'undefined'", "'string'", "'number'", 
			"'boolean'", "'any'", "'const'", "'let'", "'var'", "'int'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING_LITERAL", "TEMPLATE_LITERAL", "DECIMAL_INTEGER_LITERAL", "HEX_INTEGER_LITERAL", 
			"OCTAL_INTEGER_LITERAL", "BINARY_INTEGER_LITERAL", "FLOAT_LITERAL", "LINE_COMMENT", 
			"BLOCK_COMMENT", "WS", "HTML_WS", "HTML_OPEN_BRACE", "HTML_CLOSE_BRACE", 
			"HTML_CLOSE_PAREN", "HTML_OPENTAG", "HTML_TEXT"
		};
	}
	...
	public static final String _serializedATN =
		...
		"q\u0001q\u0003q\u03ab\bq\u0001r\u0001r\u0005r\u03af\br\nr\fr\u03b2\tr"+
		"\u0001r\u0001r\u0001s\u0001s\u0005s\u03b8\bs\ns\fs\u03bb\ts\u0001s\u0003"+
		"s\u03be\bs\u0001t\u0001t\u0001t\u0001t\u0004t\u03c4\bt\u000bt\ft\u03c5"+
		"\u0001u\u0001u\u0004u\u03ca\bu\u000bu\fu\u03cb\u0001v\u0001v\u0001v\u0001"+
		"v\u0004v\u03d2\bv\u000bv\fv\u03d3\u0001w\u0005w\u03d7\bw\nw\fw\u03da\t"+
		"w\u0001w\u0001w\u0004w\u03de\bw\u000bw\fw\u03df\u0001x\u0001x\u0001x\u0001"+
		"x\u0005x\u03e6\bx\nx\fx\u03e9\tx\u0001x\u0001x\u0001y\u0001y\u0001y\u0001"+
		"y\u0005y\u03f1\by\ny\fy\u03f4\ty\u0001y\u0001y\u0001y\u0001y\u0001y\u0001"+
		"z\u0004z\u03fc\bz\u000bz\fz\u03fd\u0001z\u0001z\u0001{\u0001{\u0001{\u0001"+
		"|\u0004|\u0406\b|\u000b|\f|\u0407\u0001|\u0001|\u0001}\u0001}\u0001}\u0001"+
